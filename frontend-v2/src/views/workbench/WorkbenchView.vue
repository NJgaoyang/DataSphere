...
<style scoped>
.workbench{padding-top:10px;padding-bottom:36px;background:linear-gradient(180deg,#fbfdff 0%,#f8fbff 100%)}
...
.metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.metric-card{position:relative;min-height:100px;padding:10px 16px;border:1px solid #e4ebf5;border-radius:12px;background:rgba(255,255,255,.94);box-shadow:0 6px 18px rgba(42,83,163,.035);overflow:hidden}.metric-card:after{content:"";position:absolute;right:-30px;top:-34px;width:76px;height:76px;border-radius:50%;background:radial-gradient(circle,rgba(59,130,246,.07),rgba(59,130,246,0) 70%)}.metric-card__top{display:flex;align-items:center;gap:8px}.metric-icon{width:28px;height:28px;border-radius:8px;display:grid;place-items:center;background:#edf5ff;color:#347ff3}.metric-label{color:#61718a;font-size:12px;font-weight:600}.metric-value{margin-top:6px;color:#0a2142;font-size:26px;line-height:1;font-weight:750;letter-spacing:-.4px}.metric-hint{margin-top:5px;color:#8b99ad;font-size:10px;line-height:1.4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.metric-card--danger .metric-icon{background:#fff2f0;color:#d94d3f}.metric-card--danger .metric-value{color:#bd3529}.metric-card--success .metric-icon{background:#edf9f4;color:#19a66a}
