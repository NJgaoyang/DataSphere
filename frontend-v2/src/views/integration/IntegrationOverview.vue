...
<style scoped>
.integration-overview{padding-top:10px;padding-bottom:36px;background:linear-gradient(180deg,#fbfdff 0%,#f8fbff 100%)}.refresh-btn{border-color:#d8e4f4!important;color:#31506f!important;background:#fff!important}
.integration-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.metric-tile{min-height:92px;display:grid;grid-template-columns:32px minmax(0,1fr) 16px;align-items:center;gap:11px;padding:12px 16px;border:1px solid #e4ebf5;border-radius:12px;background:rgba(255,255,255,.96);box-shadow:0 6px 18px rgba(42,83,163,.035);text-align:left;cursor:pointer;transition:.18s ease}.metric-tile:hover{transform:translateY(-1px);border-color:#ceddf1;box-shadow:0 14px 34px rgba(42,83,163,.075)}.metric-icon{width:32px;height:32px;border-radius:9px;display:grid;place-items:center;background:#edf5ff;color:#347ff3}.metric-icon i{font-style:normal;font-weight:800}.icon-batch i{width:16px;height:14px;border:1.8px solid currentColor;border-radius:3px;box-shadow:inset 0 -4px 0 rgba(52,127,243,.12)}.icon-live i{width:14px;height:14px;border-radius:50%;border:1.8px solid currentColor;box-shadow:0 0 0 4px rgba(52,127,243,.10)}.icon-run i{width:0;height:0;border-left:11px solid currentColor;border-top:7px solid transparent;border-bottom:7px solid transparent;margin-left:3px}.metric-copy{min-width:0}.metric-copy em,.metric-copy strong,.metric-copy small{display:block;font-style:normal}.metric-copy em{color:#61718a;font-size:11px;font-weight:650}.metric-copy strong{margin-top:4px;color:#0a2142;font-size:25px;line-height:1;font-weight:750}.metric-copy small{margin-top:4px;color:#8b99ad;font-size:10px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.metric-tile>b{color:#9aabc0;font-size:20px}.metric-tile--danger .metric-icon{background:#fff2f0;color:#d94d3f}.metric-tile--danger .metric-copy strong{color:#bd3529}
...
.integration-overview .metric-tile{min-height:92px;padding:12px 16px}
...
.integration-overview .metric-copy em{color:#73849c}.integration-overview .metric-copy strong{color:#0b2142;font-size:25px}.integration-overview .metric-copy small{color:#95a2b5}
