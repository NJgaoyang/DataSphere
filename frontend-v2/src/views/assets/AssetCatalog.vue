...
.view-switch{height:36px;display:flex;gap:4px;padding:3px;background:#eef1f5;border-radius:9px;align-items:center}.view-switch button{height:30px;border:0;background:transparent;border-radius:7px;color:#667085;padding:0 13px;cursor:pointer}.view-switch button.active{background:#fff;color:#245fd8;font-weight:600;box-shadow:0 1px 3px rgba(16,24,40,.08)}
